...
export default function AboutSection() {
  return (
    <section className="py-12 md:py-32 bg-black text-white overflow-hidden" id="about">
              ...
              {reasons.map((reason, index) => (
                <ScrollView key={index} delay={0.3 + (index * 0.1)}>
                  <div className="flex gap-4 group">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-semibold text-white mb-2">{reason.title}</h3>
                      <p className="text-sm md:text-base text-white/60 leading-relaxed">{reason.description}</p>
                    </div>
                  </div>
                </ScrollView>
              ))}
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <ScrollView delay={0.4}>
              <div className="grid grid-cols-2 gap-3 md:gap-6">
                <div className="space-y-3 md:space-y-6 translate-y-6 md:translate-y-12">

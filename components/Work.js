...
export default function Work() {
  ...
  return (
    <section className="w-full min-h-screen bg-black text-white py-12 md:py-16 px-4">
      <div className="max-w-[1200px] mx-auto">
        {/* ===== Section Header ===== */}
        <div className="flex flex-row justify-between items-center mb-8 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-yellow-400">Case Study</h2>
          <div className="flex gap-3 md:gap-4">
            <button
              onClick={prevProject}
              className="border border-white rounded-full p-2 md:p-3 hover:bg-white hover:text-black transition flex items-center justify-center w-10 h-10 md:w-12 md:h-12"
            >
              &#8592;
            </button>
            <button
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-10 overflow-hidden">
          <AnimatePresence initial={false} mode="wait">
            <motion.div
              ...
              className="flex flex-col md:flex-row w-full gap-8 md:gap-10 items-start md:items-center"
            >
              {/* ===== Left Side (Text + Logo) ===== */}
              <div className="flex-1 w-full order-2 md:order-1">
                ...
                <div className="mb-2">
                  <Image
                    ...
                    width={180}
                    height={60}
                    className="object-contain max-w-[140px] md:max-w-[180px]"
                  />
                </div>

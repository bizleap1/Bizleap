export const BLOGS_DATA = [
  {
    ...
    faqs: [
      {
        question: "How long does it take to implement a custom LLM for an enterprise?",
        answer: "Typically, the initial integration and fine-tuning process takes between 4 to 8 weeks, depending on the complexity of your data pipelines and specific automation needs."
      },
      {
        question: "Is enterprise data secure when using generative AI?",
        answer: "Yes, Bizleap uses isolated, private models that do not train on your proprietary data for public release. Data privacy and enterprise-grade security are the foundations of our integrations."
      },
      {
        question: "What is the expected ROI from AI integration?",
        answer: "While results vary by industry, our clients typically see a 30% reduction in operational costs within the first quarter and significant increases in content velocity and sales conversion rates."
      }
    ]
  },
  {

// pages/work/tulirestro.js
import Image from "next/image";
import Link from "next/link";

export default function TuliRestro() {
  return (
    <div className="w-full min-h-screen bg-white text-black">
      ...
      <div className="relative w-full h-[40vh] md:h-[55vh]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-12 px-6 md:px-20">
          ...
          >
            ...
            <span className="opacity-50">|</span>
            <span className="font-semibold text-white">Tuli Restro</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-6 md:px-20 py-16 md:py-24">
        <div className="max-w-4xl mx-auto md:max-w-none md:mx-0">
          ...
          >
            <p>
              <strong className="text-gray-900">Tuli Restro</strong> combines fine dining and a vibrant ambiance to redefine culinary luxury and elevate the overall gastronomic experience.
            </p>
          </div>

          {/* Tags */}
          <div className="flex flex-wrap gap-3 mt-12">
            {["Brand Strategy", "Design", "Fine Dining", "Luxury Experience"].map((tag, idx) => (
              <span
                key={idx}
      ...
      <div className="w-full overflow-hidden space-y-4 md:space-y-8 px-6 md:px-0">
        <div className="relative w-full h-auto rounded-lg overflow-hidden shadow-lg">
          <Image
            src="/images/Tuii2.png"
            alt="Tuli Restro Project Visual"
            width={1920}
            height={1080}

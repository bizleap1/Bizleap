...
export default function ContractToHirePage() {
  const aiFeatures = [
    {
      ...
      description: "Assess actual on-the-job performance before committing.",
      delay: 0.1
    },
    {
      icon: FiStar,
      title: "Cultural Assessment",
      description: "Ensure the candidate truly fits your team dynamics.",
      delay: 0.2
    },
    {
      icon: FiStar,
      title: "Budget Flexibility",
      description: "Manage headcount budgets more effectively during the trial.",
      delay: 0.30000000000000004
    },
    {
      icon: FiStar,
      title: "Seamless Transition",
      description: "Smooth conversion to permanent status when ready.",
      delay: 0.4
    },
    {
      icon: FiStar,
      title: "Reduced Hiring Mistakes",
      description: "Avoid the high costs of bad permanent hires.",
      delay: 0.5
    },
    {
      icon: FiStar,
      title: "Immediate Impact",
      description: "Get work done while evaluating for the long term.",
  ...
  const processSteps = [
    {
      ...
      description: "Setting clear expectations for the contract period."
    },
    {
      number: "02",
      title: "Performance Monitoring",
      description: "Regular check-ins on milestones and cultural fit."
    },
    {
      number: "03",
      title: "Evaluation Review",
      description: "End-of-contract assessment to decide on permanent offer."
    },
    {
      number: "04",
      title: "Conversion",
      description: "Seamlessly transitioning the candidate to your payroll."
    }
  ]
  ...
  return (
    <>
      <Head>
        <title key="title">Contract To Hire | Bizleap</title>
        <meta name="description" content="Evaluate talent on the job before making a permanent commitment." key="description" />
        <meta name="keywords" content="contract to hire, temp-to-perm, evaluation hiring" />
        <link rel="canonical" href="https://bizleap.in/contract-to-hire" />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://bizleap.in/contract-to-hire",
        ...
        <section className="relative pt-32 pb-20 px-6 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center text-left">
              <div>
                <ScrollReveal>
                  <Badge variant="outline" className="mb-6">Risk-Free Hiring</Badge>
                </ScrollReveal>
                <ScrollReveal delay={0.1}>
                  <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
                    Hire with Confidence: <br />
<span className="text-yellow-500">Contract to Hire</span>
                  </h1>
                </ScrollReveal>
                <ScrollReveal delay={0.2}>
                  <p className="text-xl text-gray-300 mb-10 leading-relaxed">
                    Mitigate hiring risks by evaluating a candidates skills and cultural fit on the job before making a permanent offer. The ultimate "try before you buy" solution.
                  </p>
                </ScrollReveal>
          ...
          <div className="max-w-6xl mx-auto">
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-4xl font-bold mb-6">Why Contract to Hire?</h2>
                <p className="text-gray-400 text-lg">
                  The perfect balance of flexibility and long-term security.
                </p>
              </div>
            </ScrollReveal>
        ...
        <section className="py-24 px-6 bg-black">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <ScrollReveal>
                  <h2 className="text-4xl font-bold mb-8">The Trial <span className="text-yellow-500">Period</span></h2>
                  <p className="text-gray-400 text-lg mb-12">
                    How we manage the transition from contract to permanent employee.
                  </p>
                </ScrollReveal>
